...
func define_theme():
	...
	var button_style = stylebox_flat({
		...
		bg_color = background_color.darkened(.5),
	...
	var focus_style = inherit(button_style, stylebox_flat({
		border_color = Color(text_color, 0.3),
		draw_center = false,
	}))


	var pressed_style = inherit(button_style, stylebox_flat({
