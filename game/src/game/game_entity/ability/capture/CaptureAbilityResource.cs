...
[GlobalClass]
public partial class CaptureAbilityResource : HOBAbility {
  public override Instance CreateInstance(GameplayAbilitySystem abilitySystem) {
    return new Ability(this, abilitySystem);
  }

  public partial class Ability : EntityInstance {
    private WaitForGameplayEventTask? Task { get; set; }

    public Ability(HOBAbility abilityResource, GameplayAbilitySystem abilitySystem)
