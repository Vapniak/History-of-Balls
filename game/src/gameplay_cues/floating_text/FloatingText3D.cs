...
public partial class FloatingText3D : Node3D {
  ...
  public static FloatingText3D Create() {
    var floatingText = ResourceLoader.Load<PackedScene>(_sceneUID).Instantiate<FloatingText3D>();
